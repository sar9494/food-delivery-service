...
userSignUpRouter.get('/signup',isEmailValue,checkEmailValue,checkUserSigned)
userSignUpRouter.post('/signup',isPassValue,checkPassValue,checkConfirmPassword,userSignUpController)